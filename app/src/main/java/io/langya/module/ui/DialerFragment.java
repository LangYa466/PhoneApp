...
public class DialerFragment extends Fragment {
    ...
    private final androidx.activity.result.ActivityResultLauncher<String> callPermLauncher =
            registerForActivityResult(new ActivityResultContracts.RequestPermission(), granted -> {
                if (granted) placeCall();
                else toast(getString(R.string.toast_need_call_permission));
            });

    private final androidx.activity.result.ActivityResultLauncher<String> contactsPermLauncher =
            registerForActivityResult(new ActivityResultContracts.RequestPermission(), granted -> {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        b.btnCall.setIcon(new IconicsDrawable(requireContext(), GoogleMaterialOutlined.Icon.gmo_call));
